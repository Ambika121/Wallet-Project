...
public class ServiceImplimentation {
	...
	public void createAccount(String name, int mobile, BigDecimal balance) throws MobileNoAlreadyExistsException, MobileIsNullException, NameIsNullException {
		// TODO Auto-generated method stub
		data.newAccount(name, mobile, balance);
	}

	
	public void deposit(int mobile, BigDecimal balance) throws MobileNotFoundException {
		// TODO Auto-generated method stub
		data.deposit(mobile, balance);
	}

	
	public void Withdraw(int mobile, BigDecimal balance)
			throws MobileNotFoundException, InsufficienBalanceException {
		// TODO Auto-generated method stub
		data.withdraw(mobile, balance);
	}

	
	public void Transfer(int mobile1, int mobile2, BigDecimal balance)
			throws MobileNotFoundException, InsufficienBalanceException {
		// TODO Auto-generated method stub
		data.transfer(mobile1, mobile2, balance);
	...
	/*Repository repository = new RepositoryImplimentation();
